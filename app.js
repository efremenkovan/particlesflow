...
const sketch = ({width,height}) => {
  ...
  class Dot {
    ...
    draw(context, playhead) {
      if(playhead > 1/24) this.move(playhead)
      context.save()
    ...
    applyGravity() {
      ...
      this.x += forceX*this.gravity*this.friction*this.acceleration
      this.y += forceY*this.gravity*this.friction*this.acceleration
    }
  }
